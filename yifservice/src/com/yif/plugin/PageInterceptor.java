...
public class PageInterceptor implements Interceptor {
    ...
    private static String defaultPageSqlId = ".*\\.list.*"; // 需要拦截的ID(正则匹配)
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Properties prop = configuration.getVariables();
...
//            } 
    ...
    public StringBuilder buildPageSqlForMysql(String sql, Pagination page) {
        ...
        String beginrow = String.valueOf(page.getFirstResult());
        pageSql.append(sql);
        pageSql.append(" limit " + beginrow + "," + page.getS());
        return pageSql;
    }
